...
static void (*orig_layoutSubviews)(id, SEL) = NULL;
static void replaced_layoutSubviews(id self, SEL _cmd) {
    if (orig_layoutSubviews) orig_layoutSubviews(self, _cmd);
    BDCollapseCell(self);
}
...
static void BDHookTargetClass(NSString *className) {
    ...
    BDHookSelectorIfExists(cls, @selector(layoutSubviews), (IMP)replaced_layoutSubviews, (IMP *)&orig_layoutSubviews, "v@:");
